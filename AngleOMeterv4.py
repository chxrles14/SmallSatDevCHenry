...
while True:
	...
	try:
	    ...
	    print("Roll Angle: " + str(kalAngleX))
	    print("Pitch Angle: " + str(kalAngleY))
	    print("Yaw Angle: " + str(kalAngleZ))
	    #print("Roll Angle: " + str(kalAngleX)+"   " +"Pitch Angle: " + str(kalAngleY)+"   " +"Yaw Angle: " + str(kalAngleZ))
